...
$deltec_venue = array();
$deltec_getvenue = tribe_get_venue();
$deltec_venue['venue'] = $deltec_getvenue;
?>

<div id="tribe-events-event-<?php echo esc_attr( $event_id ); ?>" class="<?php tribe_events_event_classes() ?>" data-tribejson='<?php echo esc_attr( tribe_events_template_data( $post, $deltec_venue ) ); ?>'>
