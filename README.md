...
=== CSS Classes: ===
* `deltec-tribe-events-location` - Within the tooltip/popup the text 'Location: Event-Location-Here' and street address (if enabled) is wrapped in this class. Use this to style the additional information added to the popup.
